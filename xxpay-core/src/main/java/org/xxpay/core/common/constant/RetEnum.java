...
public enum RetEnum {
    ...
    RET_HIS_MCH_TRADE_ORDER_TO_HIS_USER_ID_REQUIRED(17014, "对应的his收银员用户不存在"),
    RET_HIS_MCH_TRADE_ORDER_TO_HIS_ROLE_ERROR(17015, "小程序对应的角色只能是收银员、商户管理员、卫健委和平台运营商"),
    RET_HIS_MCH_TRADE_ORDER_TO_HIS_HOSPITALID_REQUIRED(17016, "商户管理员角色对应的医院ID为空"),
    RET_HIS_MCH_TRADE_ORDER_TO_HIS_AREACODE_REQUIRED(17017, "小程序卫健委角色对应的县区码值为空"),
